...
This method takes the string generated by C<freeze> and returns an appropriate
...
Returns a string that, when sent to C<thaw>, will recreate the object.
