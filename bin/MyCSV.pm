...
# Copyright from original Text::CSV module:

# Copyright (c) 1997 Alan Citterman. All rights reserved.
# This program is free software; you can redistribute it and/or
# modify it under the same terms as Perl itself.

# Modifications by Aaron Priven, AC Transit, 2002
...
#    original version
# Version 0.02  11/22/2002
#    NOT AN OFFICIAL RELEASE
#    modified by Aaron Priven
#
# this just involved removing the bad character check. I must admit 
# I don't understand why there is a bad character check in the first place.
# I mean, why does this routine care? FileMaker files have vertical tabs, 
# \013 (representing embedded carriage return characters in the field)
# and \035 (which divides multiple entries in repeating fields).
# 
# I also removed the autoloader bit.
#
################################################################################
...
sub _bite {
  ...
  while (1) {
    ...
    # now this will match any character - ARP
