...
Actium::O::Files::HastusASI::Definition - singleton object/class for
...
Actium::O::Files::HastusASI::Definition is a singleton class containing
...
L<Actium::O::Files::HastusASI|Actium::O::Files::HastusASI>  module.
...
C<Actium::O::Files::HastusASI::Definition-E<gt>instance>. (This is
unlike standard Moose classes and most other perl classes, which create
