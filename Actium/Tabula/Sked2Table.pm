...
package Actium::Tabula::Sked2Table 0.001;
...
sub sked2table {
    my $file       = shift; # sked filespec
    my $signup = shift; # signup directory
    my %timepoints = %{+shift}; # timepoints from an FPread
