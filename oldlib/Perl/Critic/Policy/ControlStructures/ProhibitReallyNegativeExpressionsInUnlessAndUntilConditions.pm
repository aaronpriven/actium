...
Perl::Critic::Policy::ControlStructures::ProhibitReallyNegativeExpressionsInUnlessAndUntilConditions
- Don't use operators like C<not>, C<!~>, and C<le> within C<until> and
C<unless>.
